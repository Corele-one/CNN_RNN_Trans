...
def train_model_process(model,train_dataloader,val_dataloader,num_epochs):
    ...
    #保存最高准确率下的模型参数
    torch.save(best_model_wts,'.\ResNet_18\\best_model.pth')#保存最好的模型
...
def matplot_acc_loss(train_process):
    ...
    plt.xlabel("epoch")
    plt.ylabel("Acc")
    plt.savefig(".\\ResNet_18\\train_process.png")
    plt.show()
...
if __name__ == "__main__":
    ...
    train_process = train_model_process(ResNet18,train_dataloader,val_dataloader,num_epochs=50)
