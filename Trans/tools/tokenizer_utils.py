...
def chinese_tokenizer_load():
    ...
    sp_chn.Load('{}.model'.format("D:\\23644\\code\\CNN_RNN_Trans\\Trans\\tools\\tokenizer\chn"))
    # 返回加载好的分词器对象
    return sp_chn
...
def english_tokenizer_load():
    ...
    sp_eng.Load('{}.model'.format("D:\\23644\\code\\CNN_RNN_Trans\\Trans\\tools\\tokenizer\eng"))
    # 返回加载好的分词器对象
    return sp_eng